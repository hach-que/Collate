/*
 * Name:            Collate.Account.BlockExplorer
 * Author:          James Rhodes
 * License:         MIT License
 *
 * Description:
...
Collate.Account.BlockExplorer = Class.create(Collate.Account, {
...
// </summary>
Collate.Account.BlockExplorer.Name = "Block Explorer (Wallet)";

// <summary>
// The account type description (to be shown in the New Account wizard).
// </summary>
Collate.Account.BlockExplorer.Description = "<i>Connects to the block explorer to show you transactions to and from your account in a secure manner.</i><br/><br/><strong>The method this explorer uses to calculate the BitCoin total is buggy; use the BlockChain Explorer for a correct total.</strong>";

// <summary>
// The account parameter list.
// </summary>
Collate.Account.BlockExplorer.Parameters = [
